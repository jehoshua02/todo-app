...
| Screen | Desktop | Mobile |
|--------|---------|--------|
| Edit form | ![](screenshots/task-scheduling-edit-desktop.png) | ![](screenshots/task-scheduling-edit-mobile.png) |
| Detail view | ![](screenshots/task-scheduling-detail-desktop.png) | ![](screenshots/task-scheduling-detail-mobile.png) |
| List view | ![](screenshots/task-scheduling-list-desktop.png) | ![](screenshots/task-scheduling-list-mobile.png) |
| Cleared | ![](screenshots/task-scheduling-cleared-desktop.png) | ![](screenshots/task-scheduling-cleared-mobile.png) |
