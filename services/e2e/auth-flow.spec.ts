...
test.describe("Auth + Lists flow", () => {
  ...
  test("user can set scheduling fields on a task", async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot("task-scheduling-edit.png");
    ...
    await expect(page).toHaveScreenshot("task-scheduling-detail.png");
    ...
    await expect(page).toHaveScreenshot("task-scheduling-list.png");
  });

  test("scheduling fields can be cleared", async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot("task-scheduling-cleared.png");
  });
});
